...
function ai_theme_scripts() {
	// load bootstrap css
	wp_enqueue_style( 'ai-theme-bootstrap-css', get_template_directory_uri() . '/css/bootstrap.min.css' );
	// load Font Awesome css
	wp_enqueue_style( 'ai-theme-font-awesome', get_template_directory_uri() . '/css/font-awesome.min.css', false, '4.1.0' );
	// load AItheme styles
	wp_enqueue_style( 'ai-theme-style', get_stylesheet_uri() );
	// load bootstrap js
	wp_enqueue_script('ai-theme-bootstrapjs', get_template_directory_uri() . '/js/bootstrap.min.js', array('jquery') );
